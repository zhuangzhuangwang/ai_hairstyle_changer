  ...
  return (
    <section id={section.name} className="py-16">
      <div className="lg:container px-8">
        <div className="mb-16 max-w-3xl px-8 lg:px-0">
          {section.label && (
            <Badge variant="outline" className="mb-4">
              {section.label}
            </Badge>
          )}
          <h2 className="mb-6 text-pretty text-6xl font-bold lg:text-4xl">
            {section.title}
          </h2>
          ...
          {section.email && (
            <a href={`mailto:${section.email}`} className="text-amber-700">
              📧 Email: {section.email}
            </a>
          )}
        </div>
